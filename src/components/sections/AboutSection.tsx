      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-24 sm:mt-32 mb-16 sm:mb-24">
          <div className="text-center mb-10 sm:mb-16 px-5 sm:px-0">
            <h3 className="text-[2.2rem] sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight mb-3 text-center flex flex col items-center sm:block"><span className="block sm:inline">PROFESSIONAL</span><span className="block sm:inline mt-1 sm:mt-0"> SKILLSET</span></h3>
